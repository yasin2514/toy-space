        ...
        <div data-aos="zoom-in"
            ...
            <div className="bg-black bg-opacity-40 w-full h-full py-24">
                <div className="mb-10 text-center space-y-6 bg-black bg-opacity-5">
                    <h2 className="text-red-600 text-3xl md:text-5xl">10% Discount</h2>
                ...
                <div className="text-6xl mx-12 md:w-1/2 md:mx-auto p-16 rounded-xl font-bold shadow shadow-white text-center bg-black text-white">
